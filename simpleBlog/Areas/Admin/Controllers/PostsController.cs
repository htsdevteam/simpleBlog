...
namespace simpleBlog.Areas.Admin.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            var baseQuery = Database.Session.Query<Post>().OrderByDescending(
                f => f.CreatedAt);
        ...
        public ActionResult Form(PostsForm form)
        {
            ...
            else
            {
                ...
                foreach (var toAdd in selectedTags
                    .Where(t => !post.Tags.Contains(t)))
                {
                    post.Tags.Add(toAdd);
                }
                foreach (var toRemove in post.Tags
                    .Where(t => !selectedTags.Contains(t)).ToList())
                {
        ...
        private IEnumerable<Tag> ReconsileTags(IList<TagCheckbox> tags)
        {
            foreach (var tag in tags.Where(t => t.IsChecked))
            {
                ...
                var existingTag = Database.Session.Query<Tag>()
